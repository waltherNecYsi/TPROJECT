...
const FORMAT_PDFV2 = ['pdf'];
const FORMAT_TEXT = ['txt'];
const FORMAT_PHOTOSHOP = ['psd'];
const FORMAT_WORD = ['doc', 'docx'];
const FORMAT_EXCEL = ['xls', 'xlsx'];
const FORMAT_EXCELV2 = ['xls', 'xlsx'];
...
export function fileFormat(fileUrl) {
  ...
  switch (fileUrl?.includes(fileTypeByUrl(fileUrl))) {
    ...
    case FORMAT_EXCEL.includes(fileTypeByUrl(fileUrl)):
      format = 'excel';
      break;
    case FORMAT_EXCELV2.includes(fileTypeByUrl(fileUrl)):
      format = 'excelv2';
      break;
    ...
    case FORMAT_PDF.includes(fileTypeByUrl(fileUrl)):
      format = 'pdf';
      break;
    case FORMAT_PDFV2.includes(fileTypeByUrl(fileUrl)):
      format = 'pdfv2';
      break;
